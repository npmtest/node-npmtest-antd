...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-antd/node_modules/antd/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-antd/node_modules/antd/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-antd/node_modules/antd/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="if path not taken" >I</span>if (ENV !== 'production' &amp;&amp; ENV !== 'test' &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >typeof console !== 'undefined' </span>&amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >console.warn </span>&amp;&amp; <span class="branch-4 cbranch-no" title="branch not covered" >typeof window !== 'undefined')</span> {
<span class="cstat-no" title="statement not covered" >    console.warn('You are using a whole package of antd, ' + 'please use https://www.npmjs.com/package/babel-plugin-import to reduce app bundle size.');</span>
}
&nbsp;</pre></td></tr>
</table></pre>
</div>
